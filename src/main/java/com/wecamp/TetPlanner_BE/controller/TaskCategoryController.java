...
public class TaskCategoryController {
    ...
    @GetMapping
    public ResponseEntity<BaseResponse<List<TaskCategoryResponse>>> getAllTaskCategories(Authentication authentication) {
    ...
    @GetMapping("/{id}")
    public ResponseEntity<BaseResponse<TaskCategoryResponse>> getTaskCategoryById(Authentication authentication, @PathVariable Long id) {
        try {
            UUID userId = UUID.fromString(authentication.getName());
    ...
    @PostMapping
    public ResponseEntity<BaseResponse<TaskCategoryResponse>> createTaskCategory(Authentication authentication, @Valid @RequestBody TaskCategoryRequest request) {
        try {
            UUID userId = UUID.fromString(authentication.getName());
    ...
    @PutMapping("/{id}")
    public ResponseEntity<BaseResponse<TaskCategoryResponse>> updateTaskCategory(Authentication authentication, @PathVariable Long id, @Valid @RequestBody TaskCategoryRequest request) {
        try {
            UUID userId = UUID.fromString(authentication.getName());
    ...
    @DeleteMapping("/{id}")
    public ResponseEntity<BaseResponse<?>> deleteTaskCategory(Authentication authentication, @PathVariable Long id) {
        try {
            UUID userId = UUID.fromString(authentication.getName());
