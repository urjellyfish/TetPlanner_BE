...
import com.wecamp.TetPlanner_BE.dto.response.BudgetProgressResponse;
...
public class BudgetController {
        ...
        public ResponseEntity<BaseResponse<BudgetListResponse>> getAllBudgets(
                ...
                BudgetListResponse response = budgetService.getBudgetsForUser(userId,
        ...
        public ResponseEntity<BaseResponse<BudgetProgressResponse>> getBudgetProgress(
                        Authentication authentication,
                        @PathVariable UUID budgetId) {
                UUID userId = UUID.fromString(authentication.getName());
                BudgetProgressResponse response = budgetService.getBudgetProgress(userId, budgetId);
                return ResponseEntity
                                .ok(new BaseResponse<>(
                                                true,
